    ...
    <section className="about section-pad" id="nosotros">
      ...
      <div className="about-media reveal reveal-delay-2">
        <figure className="about-main">
          <img src={about.images.main} alt="Proyecto Juárez 001" loading="lazy" decoding="async" />
        </figure>
        <figure className="about-accent">
          <img src={about.images.accent} alt="Detalle de interiorismo cálido" loading="lazy" decoding="async" />
        </figure>
